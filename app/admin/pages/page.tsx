...
import { FileText, Save, Trash2, PlusCircle, Pencil, X, Home } from 'lucide-react';
...
export default async function AdminPagesManagement(props: {
    ...
    // 2. Récupérer les textes de la page d'accueil depuis 'page_contents'
    ...
    // 3. Action du serveur : Sauvegarder (Ajout / Modification)
    ...
    // 4. Action du serveur : Supprimer une page
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div className={`p-6 rounded-2xl shadow-sm border h-fit xl:col-span-1 ${pageToEdit ? 'bg-amber-50 border-amber-200' : 'bg-white border-slate-200'}`}>
                    ...
                    <form key={pageToEdit?.slug || 'new'} action={savePage} className="space-y-4">
                        ...
                        {/* On cache les blocs de contenu s'il s'agit de la page d'accueil générale */}
